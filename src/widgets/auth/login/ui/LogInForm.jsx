        ...
        <WrapperInputs className="flex justify-center gap-4 mb-6">
          ...
          <View style={{ position: 'relative' }}>
            ...
            <TouchableOpacityStyled
              ...
              {showPassword ? <Icon xml={closedEyeIcon} /> : <Icon xml={openEyeIcon} />}
            </TouchableOpacityStyled>
          </View>
        </WrapperInputs>
      </KeyboardAvoidingView>
      <Link href="/password-reset" className='self-center font-normal text-sm leading-normal underline text-black'>
        Забули пароль?
      </Link>
      <PrimaryButton
        text='Увійти'
